...
#         sleep(1)
#         self.driver.find_element_by_xpath('//*[@id="skin_cover_s"]/div/a/img')
#     def close(self):
#         self.driver.close()
# driver = Driver()
# driver.open()
...
class Driver:
    ...
    def open(self):
        ...
        for i in range(10):
            ...
            self.driver.find_element_by_class_name("pos").click()
            print(">>>打开转发框>>>")
            sleep(3)
            # self.driver.find_element_by_xpath("/html/body/div[10]/div[2]/div[3]/div/div[2]/div/div[2]/div/div[1]/div/div[1]/textarea").click()
            self.driver.find_element_by_xpath('//*[@id="layer_15093739499661"]/div[2]/div[3]/div/div[2]/div/div[2]/div/div[1]/div/div[1]/textarea').click()
            print(">>>转发语>>>")
            sleep(3)
            ...
            self.driver.find_element_by_xpath('//*[@id="layer_15093739499661"]/div[2]/div[3]/div/div[2]/div/div[2]/div/div[1]/div/div[1]/textarea').send_keys("[TEST]Auto-Forward Script No." + str(i+1))
            sleep(3)
            # 选择公开/私密
